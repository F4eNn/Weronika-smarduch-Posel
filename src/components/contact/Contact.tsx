					...
					<div className='relative mx-auto mt-12 flex items-center justify-center overflow-hidden pt-20 lg:h-[875px] lg:w-[975px] xl:w-10/12'>
						...
						<div className='mb-20 flex flex-col  items-center space-y-10'>
							...
							<a
								...
								className='flex items-center gap-3 rounded-[30px] border-[1px] border-darkBlue px-14 py-4 text-lg font-[500] transition-colors duration-300 hover:border-secondaryHover hover:bg-secondaryHover hover:text-white '
							>
